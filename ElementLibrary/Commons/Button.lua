...
CButton = function(inButtonTable)
          local t = {
                    t = "JkrGUIv2",       -- Text
          ...
          return { CButton = Default(inButtonTable, t) }
end

gprocess["CButton"] = function(inPresentation, inValue, inFrameIndex, inElementName)
...
ExecuteFunctions["*CB*"] = function(inPresentation, inElement, inFrameIndex, t, inDirection)
